...
class InventariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create inventario" do
    assert_difference("Inventario.count") do
      post inventarios_url, params: { inventario: { area_total_m2: @inventario.area_total_m2, cajas_completas: @inventario.cajas_completas, piezas_sueltas: @inventario.piezas_sueltas, producto_id: @inventario.producto_id } }
    end
  ...
  test "should update inventario" do
    patch inventario_url(@inventario), params: { inventario: { area_total_m2: @inventario.area_total_m2, cajas_completas: @inventario.cajas_completas, piezas_sueltas: @inventario.piezas_sueltas, producto_id: @inventario.producto_id } }
