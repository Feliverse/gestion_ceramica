...
class QuotationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create quotation" do
    assert_difference("Quotation.count") do
      post quotations_url, params: { quotation: { client_id: @quotation.client_id, date: @quotation.date, total: @quotation.total } }
    end
  ...
  test "should update quotation" do
    patch quotation_url(@quotation), params: { quotation: { client_id: @quotation.client_id, date: @quotation.date, total: @quotation.total } }
