...
class OrdenComprasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create orden_compra" do
    assert_difference("OrdenCompra.count") do
      post orden_compras_url, params: { orden_compra: { estado: @orden_compra.estado, fecha: @orden_compra.fecha, proveedor_id: @orden_compra.proveedor_id, total: @orden_compra.total } }
    end
  ...
  test "should update orden_compra" do
    patch orden_compra_url(@orden_compra), params: { orden_compra: { estado: @orden_compra.estado, fecha: @orden_compra.fecha, proveedor_id: @orden_compra.proveedor_id, total: @orden_compra.total } }
