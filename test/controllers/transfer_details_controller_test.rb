...
class TransferDetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create transfer_detail" do
    assert_difference("TransferDetail.count") do
      post transfer_details_url, params: { transfer_detail: { product_id: @transfer_detail.product_id, quantity: @transfer_detail.quantity, subtotal: @transfer_detail.subtotal, transfer_id: @transfer_detail.transfer_id } }
    end
  ...
  test "should update transfer_detail" do
    patch transfer_detail_url(@transfer_detail), params: { transfer_detail: { product_id: @transfer_detail.product_id, quantity: @transfer_detail.quantity, subtotal: @transfer_detail.subtotal, transfer_id: @transfer_detail.transfer_id } }
