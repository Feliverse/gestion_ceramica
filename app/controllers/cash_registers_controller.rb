class CashRegistersController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to cash_registers_path, status: :see_other, notice: "Cash register was successfully destroyed." }
  ...
  private
    ...
    def cash_register_params
      params.require(:cash_register).permit(:sale_id, :date, :total_amount)
    end
end
