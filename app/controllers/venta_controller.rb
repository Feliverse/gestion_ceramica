class VentaController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to venta_path, status: :see_other, notice: "Ventum was successfully destroyed." }
  ...
  private
    ...
    def ventum_params
      params.require(:ventum).permit(:fecha, :cliente_id, :producto_id, :cantidad_m2, :piezas_vendidas, :cajas_vendidas, :total)
    end
end
