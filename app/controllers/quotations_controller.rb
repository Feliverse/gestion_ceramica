class QuotationsController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to quotations_path, status: :see_other, notice: "Quotation was successfully destroyed." }
  ...
  private
    ...
    def quotation_params
      params.require(:quotation).permit(:client_id, :date, :total)
    end
end
