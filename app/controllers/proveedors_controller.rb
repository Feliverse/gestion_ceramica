class ProveedorsController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to proveedors_path, status: :see_other, notice: "Proveedor was successfully destroyed." }
  ...
  private
    ...
    def proveedor_params
      params.require(:proveedor).permit(:nombre, :contacto, :direccion)
    end
end
